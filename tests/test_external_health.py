...
# --- httpx 0.28: proxies= replaced with proxy= ---
...
# --- httpx 0.28: use transport=httpx.ASGITransport(app=app) instead of app= ---
...
# --- httpx 0.28: follow_redirects default is still False ---
...
# --- httpx 0.28: JSON uses compact representation (no spaces) ---
